...
- Currently studying **Spring Boot / React / Machine Learning**
- Building full-stack & AI-based projects
- Learning cloud & infrastructure with AWS
...
- [Albam Mate](https://github.com/bamsongi-club/albam-mate)  
  A platform for discovering, creating, and joining board-game meetups.

- [AI Usage Banner](https://github.com/beyejin/ai-usage-banner)  
  A macOS menu bar app that shows usage across multiple Codex and Claude accounts.
